...
Describe.scatterplot = 
    function(x, VI=FALSE, ...){
        ...
        general = paste("A scatter plot shows the relationship between two variables by plotting a symbol for each observation at the coordinates for the two variables.", .CommonAxisStyleText, .CommonTickMarkText, .CommonAspectRatioText)
...
Describe.tsplot = 
    function(x, VI=FALSE, ...){
        ...
        general = paste('A time series plot shows the behaviour of a variable over time, by plotting a symbol at the height of the variable of interest for each time point along the x-axis which is labelled as "Time" by default.', .CommonAxisStyleText, .CommonTickMarkText, .CommonAspectRatioText)
