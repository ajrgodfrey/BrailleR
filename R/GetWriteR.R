...
installr::install.pandoc(to_restart=FALSE, download_dir = getOption("BrailleR.Folder"), keep_install_file=TRUE)
...
if(require(BrailleR)){
message("This command will download a file and save it to your hard drive.")
installr::install.7zip(download_dir = getOption("BrailleR.Folder"), keep_install_file=TRUE)
message("The installer file has been added to your MyBrailleR folder.")
message("You can delete it at any time, but that will not uninstall the application.")
}
} else{warning("This function is for users running R under the Windows operating system.\n")}
...
if(require(BrailleR)){
message("This command will download a file and save it to your hard drive.")
installr::install.URL("https://www.python.org/ftp/python/2.7.11/python-2.7.11.msi", download_dir = getOption("BrailleR.Folder"), keep_install_file=TRUE)
...
if(require(BrailleR)){
message("This command will download a file and save it to your hard drive.")
installr::install.URL("http://downloads.sourceforge.net/wxpython/wxPython3.0-win32-3.0.2.0-py27.exe", download_dir = getOption("BrailleR.Folder"), keep_install_file=TRUE)
message("The installer file has been added to your MyBrailleR folder.")
message("You can delete it at any time, but that will not uninstall the application.")
}
} else{warning("This function is for users running R under the Windows operating system.\n")}
