...
AddXML.ggplot = function(x, file) {
    ...
    xAxisLabelGrob = paste0(grid.grep(
        gPath("xlab-b", "titleGrob", "text"), grep=TRUE)$name,
      ".1")
    xAxisTickLabelGrob = paste0(grid.grep(
        gPath("axis-b", "absoluteGrob", "axis", "axis", "titleGrob", "text"),
        grep = TRUE)$name,
      ".1")
    
    xAxis = .AddXMLAddXAxis(annotations,
    ...
    yAxisLabelGrob = paste0(grid.grep(
        gPath("ylab-l", "titleGrob", "text"),
        grep=TRUE)$name,
      ".1")
    yAxisTickLabelGrob = paste0(grid.grep(
        gPath("axis-l", "absoluteGrob", "axis", "axis", "titleGrob", "text"),
        grep = TRUE)$name,
      ".1")
    yAxis = .AddXMLAddYAxis(annotations,
    ...
    if (xs$npanels == 1) {
          for (layerNum in 1:xs$nlayers) {
            layer = .AddXMLAddGGPlotLayer(annotations,
